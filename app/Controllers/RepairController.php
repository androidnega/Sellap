...
class RepairController {
    ...
    public function create() {
        ...
        $products = $this->product->findByCompany($companyId, 100);
        ...
        // Capture the view content
        ob_start();
        include __DIR__ . '/../Views/repairs_create.php';
        $content = ob_get_clean();
    ...
    public function store() {
        ...
        if (!$customer_name || !$customer_contact || !$issue_description) {
            ...
            $redirectUrl = $userRole === 'technician' 
                ? BASE_URL_PATH . '/dashboard/technician/booking'
        ...
        $total_cost = $repair_cost + $parts_cost + $accessory_cost;
        ...
        try {
            ...
            if (!empty($accessories)) {
                ...
                foreach ($accessories as $accessory) {
                    ...
                    $productCost = floatval($product['cost'] ?? 0);
                    ...
                    // Create repair accessory record
    ...
    public function receipt($id) {
        ...
        $viewFile = __DIR__ . '/../Views/repairs_receipt.php';
        // Set content variable for layout
        $GLOBALS['content'] = $content;
        $GLOBALS['title'] = $title;
    ...
    public function reports() {
        ...
        $viewFile = __DIR__ . '/../Views/repairs_reports.php';
        // Set content variable for layout
        $GLOBALS['content'] = $content;
        $GLOBALS['title'] = $title;
    ...
    private function sendRepairNotifications($repairId, $companyId, $technicianId, $accessories) {
        try {
            ...
            // Notify managers about new repair
            foreach ($managers as $managerId) {
                $this->notification->create([
                    'user_id' => $managerId,
                    'company_id' => $companyId,
                    'message' => "New repair #{$repairId} has been completed by technician",
                    'type' => 'repair',
                    'data' => ['repair_id' => $repairId, 'technician_id' => $technicianId]
                ]);
            }
