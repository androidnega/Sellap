...
(function() {
  ...
  function getModuleName(moduleKey) {
    const names = {
      ...
      'holiday_broadcast_sms': 'Holiday & broadcast SMS',
      'suppliers': 'Suppliers',
  ...
  function getModuleDescription(moduleKey) {
    const descriptions = {
      ...
      'holiday_broadcast_sms': 'Schedule holiday messages to customers and one-off broadcast SMS (uses company SMS balance).',
      ...
      'manager_delete_sales': 'Legacy toggle (ignored): managers cannot delete sales; use cancel/return on the sale page',
      'manager_bulk_delete_sales': 'Legacy toggle (ignored): bulk delete is disabled with order inventory tracking',
