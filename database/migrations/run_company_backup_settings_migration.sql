-- Run this SQL script on your live server to create the company_backup_settings table
-- This allows system admin to configure auto-backup settings per company
